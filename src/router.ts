...
const routeTree = rootRoute.addChildren([indexRoute, p1Route, p2Route, p3Route, p4Route, p5Route, p6Route, p7Route, p8Route, p9Route, p10Route, p11Route, p12Route, p13Route, p14Route, p15Route, p16Route])
